    ...
    public partial class MigrationName3 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BnIId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BnIs", x => x.BnIId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BookedTimes = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Schedule", x => x.ScheduleId);
                    table.ForeignKey(
                        name: "FK_Schedule_Practitioners_PractitionerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Appointments", x => new { x.PractitionerId, x.ClientId, x.DateId });
                    table.ForeignKey(
                        name: "FK_Appointments_Claim_ClaimId",
                        column: x => x.ClaimId,
            ...
            migrationBuilder.InsertData(
                ...
                {
                    { 1, null, "Admin", "ADMIN" },
                    { 2, null, "Practitioner", "PRACTITIONER" },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Schedule_PractitionerId",
                table: "Schedule",
